			   ...
			   <div class="col-401">
				...
				<div class="col-401">
					<div class="form-group">
						...
						<input id="adr-1" name="address-1" type="text" placeholder="House number and Street name">
					</div>
				</div>
				<div class="col-401">
					<div class="form-group">
						<label for="adr-2">Address Line 2</label>
						<input id="adr-2" name="address-2" type="text" placeholder="Apartment, suite, unit etc. (optional)">
					</div>
				</div>
				<div class="col-401">
					<div class="form-group">
					...
					<div class="content">
						<div class="checkbox">
							<label for="checkpay" class="float-left custom-control custom-checkbox">
								<input id="checkpay" type="checkbox" class="custom-control-input" checked="">
								<div class="custom-control-label"> Check Payments</div>
							</label>
							<label for="cashdel" class="float-left custom-control custom-checkbox">
								<input id="cashdel" type="checkbox" class="custom-control-input" checked="">
