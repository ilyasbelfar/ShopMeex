							...
							<div class="col-50">
								...
								<form method="get">
									...
									<div class="row">
										...
										<div class="col-401">
											<div class="form-group">
												<label for="repass">Repeat Password<span>*<?php echo $repassErr; ?></span></label>
												<input name="password" type="password" placeholder="Repeat Password" id="repass" required>
											</div>
										</div>
									</div>
									<div class="form-group">
										<label for="check2" class="float-left custom-control custom-checkbox">
											<input id="check2" type="checkbox" class="custom-control-input" required>
											<div class="custom-control-label"> I agree with <a target="_blank" href="#">Terms & Conditions</a> </div>
										</label>
									</div>
									<div class="clearfix"></div>
									<div class="form-group">
