...
-->
    <div>
        ...
        <div class="content">        
            <?php<?php include 'includes/session.php'; ?>
<?php include 'includes/header-admin.php'; 
?>
...
-->
      ...
      ?>
            <main class="main-content">
                <div class="main-content flex" style="flex-wrap:wrap">
                    ...
                    <div class="row2 " style="min-width:100%">
                        <div class="row2container flex">
                            <aside class="mapaside">
                                <div class="containermapaside">
                                    <div class="title">
                                        <h4>
                                            Site Web
                                        </h4>
                                    </div>
                                    <div class="algeriamap">
                                        <div class="mapcontainer">
                                            <div class="wrappermap">
                                                <svg xmlns="http://www.w3.org/2000/svg" baseprofile="tiny" fill="#ccc" height="490" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" version="1.2" viewbox="0 0 1000 1001" width="740.071">
 ...
 <circle cx="688.5" cy="146.9" id="2">
                                                ...
                                                <div class="zoompos">+</div>
                                                <div class="zoomneg">-</div>
                                            </div>
                                        </div>                                    
                                    </div>
                                </div>
                            </aside>
                            <aside class="statstics">
     								<div class="layers">
     									<div class="layer">
     										<div class="layers">
     											<div class="layer">
                                                    <h5>100k</h5>
     												<small>Visitors From Algiers</small> 
     												<span class="pull-right">50%</span>
     												<div class="progress ">
     													<div class="progress-bar"><span class="sr-only">50% Complete</span>
     													</div>
     												</div>
     											</div>
                                                <div class="layer">
     											...
     											<div class="layer">
                                                    <h5>100k</h5>
     												...
     												<div class="progress mT-10">
     													<div class="progress-bar"  role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:50%" class="bg-bleu"><span class="sr-only">50% Complete</span>
     													</div>
     												</div>
     											</div>
     											<div class="layer">
     										...
     										<div class="peers" style="display: none">
     											<div class="peer">
     												<div class="easy-pie-chart" >
                                                        <span>75 %</span>
     													<canvas id="polor1" height="50" width="50"></canvas>
     												    <canvas id="polor2" height="50" width="50" >
                                                         </canvas>
                                                    </div>
                                                    <h6 class="fsz-sm">New Users</h6>
     											</div>
     											<div class="peer">
     												<div class="easy-pie-chart" data-size="80" data-percent="50" data-bar-color="#2196f3"><span>50 %</span>
     													<canvas height="80" width="80"></canvas>
     												<canvas height="88" width="88" style="height: 80px; width: 80px;"></canvas></div><h6 class="fsz-sm">New Purchases</h6>
     											</div>
     											<div class="peer">
     												<div class="easy-pie-chart" data-size="80" data-percent="90" data-bar-color="#ff9800"><span>90 %</span>
     													<canvas height="80" width="80"></canvas>
     												<canvas height="88" width="88" style="height: 80px; width: 80px;"></canvas></div><h6 class="fsz-sm">Bounce Rate</h6>
     											</div>
     										</div>
     									</div>
     								</div>
                    ...
                    <?php 
                        include "includes/el3.php";
                        include "includes/el4.php";
                        include "includes/el5.php";
include "includes/el6.php";
                    ?>
...
?>
 ...
 <circle cx="688.5" cy="146.9" id="2">
                    ...
                    <div class="row3 flex">
                        <div class="left-col flexdemi">
                            <div class="container"> 
                                ...
                                <div class="content-graph">
                                    <div class="con con1 fade">
                                        <div class="head">
                                            <div class="container">
                                                <div class="title">
                                                    <h4> New account since <span>2018</span></h4>
                                                </div>
                                                <div class="statis"> 
                                                    <h1>78</h1>
                                                    <span>%</span>
                                                    <p class="inc">+14%</p>
                                                    <p class="chan">increase</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="graph">
                                            <canvas id="my-graph-1"></canvas>
                                        </div>
                                    </div>
                                    <div class="con con2 fade">
                                        <div class="head">
                                            <div class="container">
                                                <div class="title">
                                                    <h4> kNew account since <span>2018</span></h4>
                                                </div>
                                                <div class="statis"> 
                                                    <h1>78</h1>
                                                    <span>%</span>
                                        ...
                                        <div class="graph">
                                            <canvas id="my-graph-2"></canvas>
                                        </div>
                                    </div>
                                    <div class="con con3 fade">
                                        <div class="head">
                                            <div class="container">
                                                <div class="title">
                                                    <h4> hNew account since <span>2018</span></h4>
                                                </div>
                                                <div class="statis"> 
                                                    <h1>78</h1>
                                                    <span>%</span>
                                        ...
                                        <div class="graph">
                                            <canvas id="my-graph-3"></canvas>
                                        </div>
                                    </div>
                                    
                                    <button class="plus" onclick="plusSlides(1)">
                                        <i class="fa fa-angle-right" ></i>
                                    </button>
                                    <button class="neg" onclick="plusSlides(-1)">
                                    ...
                                    <div class="container">
                                        <div class="botton-top">
                                            ...
                                            <div class="profit flex">
                                                <div class="order-spec">Last year
                                                    expenses
                                                </div>
                                                <div class="profit">
                                                    <small>$1896</small>
                                        ...
                                        <div class="stat">
                                            ...
                                            <div class="progress-sub-label flex">
                        ...
                        <div class="right-col left-col flexdemi">
