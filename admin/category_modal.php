...
<div class="modal fade" id="addnew">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 40px 0 30px 0 !important;">
              <form class="form-horizontal" method="POST" action="category_add.php">
                <div class="form-group">
                    <label for="name" class="control-label">Name</label>

                    <div >
                      <input type="text" style="width: 400px;outline: 0;" class="form-control"  name="name" required>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body" style=" padding: 40px 0 30px 0 !important;">
              <form class="form-horizontal" method="POST" action="category_edit.php">
                ...
                <div class="form-group">
                    ...
                    <div >
                      <input type="text" style="width: 400px;outline: 0;"  class="form-control" id="edit_name" name="name">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
