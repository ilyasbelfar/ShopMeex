...
<head>
    ...
    <title>FAQ | ShopMeex Online Store</title>
...
<body>
            ...
            <div class="container">
                <nav>
                    ...
                    <ul class="nav-items">
                        ...
                        <li class="dropdown-menu1"> <a href="#">DZD<i class="fas fa-angle-down"></i></a>
                        ...
                        <li class="dropdown-menu2"> <a href="#">English</a>
                        </li>
                    </ul>
                </nav>
            </div>
                ...
                <div class="container">
                    <div class="wrapper">
                        ...
                        <div class="user-details">
                            <div class="user-details-container"> <span class="card-container">
                                    ...
                                    <div class="mini-menu">
                                        <div class="shopping-cart-widget">
                                            <ul class="products-list">
                                                <li class="product-item"> <a href="#" class="remove-item-button">×</a>
                                                    <a href="#" class="item-details">
                                                        <img width="300" height="300" src="https://cdn.jevelin.shufflehound.com/wp-content/uploads/2016/01/Item_1.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" srcset="https://cdn.jevelin.shufflehound.com/wp-content/uploads/2016/01/Item_1.jpg 800w, https://cdn.jevelin.shufflehound.com/wp-content/uploads/2016/01/Item_1-150x150.jpg 150w, https://cdn.jevelin.shufflehound.com/wp-content/uploads/2016/01/Item_1-300x300.jpg 300w, https://cdn.jevelin.shufflehound.com/wp-content/uploads/2016/01/Item_1-768x768.jpg 768w, https://cdn.jevelin.shufflehound.com/wp-content/uploads/2016/01/Item_1-660x660.jpg 660w" sizes="(max-width: 300px) 100vw, 300px">Basic t-shirt</a>
                                                    <div class="clearfix"></div> <span class="quantitys">1 × <span>$<span class="total-amount">7.99</span></span>
                                                    </span>
                                                </li>
                                                <li class="product-item"> <a href="#" class="remove-item-button">×</a>
                                                    <a href="#" class="item-details">
                                            ...
                                            <p class="sub-buttons"> <a href="cart.html" class="forward-cart">View cart</a>
                            ...
                            <div class="widget-header1 dropdown">
                                <div class="icon"> <i class="fa fa-user"></i>
                                    <div class="user-text"> <small class="text-muted">Sign in | Sign Up</small>
                                        <div>My Account<i class="fa fa-angle-down"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="wrapper">
                <div class="col-35">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            <li><a href="index.html">Home<i class="ti-arrow-right"></i></a>
                            </li>
        ...
        <div class="container">
            <div class="wrapper">
                ...
                <div class="accordion-container">
                    <div class="set">
                        <a href="#">Tristique quam lacus sagittis laoreet? <i class="fa fa-plus"></i></a>
                        <div class="content">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi luctus semper gravida. Vestibulum dolor ex, imperdiet eget auctor sit amet, eleifend feugiat ipsum. Nulla vitae ipsum at massa dignissim convallis. Pellentesque eget justo vel risus fermentum sollicitudin.</p>
                        </div>
                    </div>
                    <div class="set">
                        <a href="#">Metus viverra sed eu scelerisque? <i class="fa fa-plus"></i></a>
                        <div class="content">
                            <p>Nulla vitae ipsum at massa dignissim convallis. Pellentesque eget justo vel risus fermentum sollicitudin.</p>
                        </div>
                    </div>
                    <div class="set">
                    ...
                    <div class="set">
                        <a href="#">Quisque maecenas aptent luctus? <i class="fa fa-plus"></i></a>
                        <div class="content">
                            <p>Amet turpis sapien. Neque ad varius viverra nec dui vehicula magna pretium suscipit vel malesuada consectetuer in.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="wrapper">
                ...
                <div class="newsletter-form">
                    ...
                    <button type="submit" name="subscribe"> <i class="fa fa-envelope"></i>
                        <span>Subscribe</span>
                    </button>
                </div>
            </div>
                ...
                <div class="wrapper">
                    ...
                    <aside>
                        ...
                        <ul>
                            ...
                            <li><a href="#"><i class="fas fa-money-check"></i>Money Refund</a>
                            </li>
                            <li><a href="#"><i class="fas fa-info-circle"></i>Order Status</a>
                            </li>
                            <li><a href="#"><i class="fa fa-shopping-bag"></i>Shipping Info</a>
                            </li>
                            <li><a href="#"><i class="fa fa-share"></i>Open Dispute</a>
                            </li>
                        </ul>
                    </aside>
                    <aside>
                        <h3>Account</h3>
                        <ul>
                            <li><a href="#"><i class="fa fa-user-circle"></i>User Login</a>
                            </li>
                            <li><a href="#"><i class="fa fa-user-plus"></i>User Register</a>
                            </li>
                            <li><a href="#"><i class="fa fa-cog"></i>Account Settings</a>
                            </li>
                            <li><a href="#"><i class="fa fa-cart-plus"></i>My Orders</a>
                            </li>
                        </ul>
                    </aside>
                    <aside>
                        ...
                        <ul class="social-media">
                            <li>
                                ...
                                <li><a href="#"><i class="fa fa-phone"></i>N° Phone</a>
                                </li>
                        </ul>
                    </aside>
                </div>
    ...
    <!-- End Footer -->
    <div class="gototop"> <a href="#" class="gotop"><i class="fa fa-arrow-up"></i></a>
    </div>
