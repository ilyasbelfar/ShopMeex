...
<head>
    ...
    <title>404 Error | ShopMeex Online Store</title>
            ...
            <div class="wrapper">
                <div class="col-35">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            <li><a href="index.php">Home<i class="ti-arrow-right"></i></a>
                            </li>
                            <li class="active"><a href="404.php">404 Error Page</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="error-page">
        <div class="container">
            <div class="wrapper">
                <div class="error-row">
                    <div class="col-90">
                        <img src="images/404-error-side-picture.svg">
                    </div>
                    <div class="col-91">
