...
<head>
    <title>My Wishlist | ShopMeex Online Store</title>
            ...
            <div class="wrapper">
                <div class="tabs-wrapper">
                        ...
                        <div class="myaccount-links">
                            ...
                            <tbody>';
                                ...
                                echo '<tr>
                                    ...
                                    <td class="image" data-title="No"><img src="../images/items/'.' "alt="#"></td>
                    ...
                    <?php if ($a==true){  
                        ...
                        echo '<div class="paneltbs panel-4" id="wishlist" style="">
                        <table class="shopping-cart">
                            <thead>
                                <tr class="main-heading">
                                    <th class="text-center" style="padding-left: 1.5rem;padding-right: 1.5rem"><i class="ti-trash remove-icon"></i></th>
